	...
	group "scdf-nexus" {
		...
		task "scdf-server-nexus" {
			...
			env {
				...
				maven.remote-repositories.nexus.url = "http://nexus.service.consul:8081/content/groups/public"
				maven.remote-repositories.nexus.auth.username = "deployment"
				maven.remote-repositories.nexus.auth.password = "deployment123"
